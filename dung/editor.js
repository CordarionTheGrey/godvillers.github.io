...
var _Godvillers$godvillers_github_io$Editor$main = _elm_lang$html$Html$beginnerProgram(
	{model: _Godvillers$godvillers_github_io$Editor_Model$model, view: _Godvillers$godvillers_github_io$Editor_View$view, update: _Godvillers$godvillers_github_io$Editor_Controller$update})();

var Elm = {};
Elm['Editor'] = Elm['Editor'] || {};
if (typeof _Godvillers$godvillers_github_io$Editor$main !== 'undefined') {
    _Godvillers$godvillers_github_io$Editor$main(Elm['Editor'], 'Editor', undefined);
}
